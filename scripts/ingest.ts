 ...
 * See the UK implementation (uk-farm-planning-mcp) for the reference pattern.
 *
...
console.log('See uk-farm-planning-mcp/scripts/ingest.ts for the reference pattern.');

db.run("INSERT OR REPLACE INTO db_metadata (key, value) VALUES ('last_ingest', ?)", [now]);
db.run("INSERT OR REPLACE INTO db_metadata (key, value) VALUES ('build_date', ?)", [now]);

writeFileSync('data/coverage.json', JSON.stringify({
  mcp_name: 'Denmark Farm Planning MCP',
  jurisdiction: 'DK',
  build_date: now,
